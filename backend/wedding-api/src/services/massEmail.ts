...
export function buildHouseholdEmail(
    ...
    const text = template === "reveal"
        ? `Quiana & Scott\n\n${recipient.householdName}\n\n${body ? `${body}\n\n` : ""}Open your invitation: https://qstodder.com/wedding/invitation.html\nPassword: rufus`
        : `${greeting}\n\n${body}`;
