        ...
        <div id="guest-content" class="hidden">
            ...
            <section class="admin-panel">
                ...
                <div class="admin-filters guest-filters">
                    ...
                    <div class="filter-field"><label for="guest-invitation-filter">Invited to</label><select id="guest-invitation-filter"><option value="all">Any event</option><option value="welcome">Welcome gathering</option><option value="wedding">Wedding</option><option value="brunch">Morning-after beach day</option></select></div>
